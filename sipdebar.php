<div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width: 280px">
        <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto link-dark text-decoration-none">
          <span class="fs-4">PERIZINAN</span>
        </a>
        <hr />
        <ul class="nav nav-pills flex-column mb-auto">
          ...
          <li>
            <a href="perizinan" class="nav-link link-dark <?php if($_GET['x']=='perizinan') echo 'active';?>">
       ...
       <path d="M6.5 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm-9 3a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2zm3 0a1 1 0 1 0 0-2 1 1 0 0 0 0 2z"/>
          ...
          <li>
            <a href="notifikasi" class="nav-link link-dark <?php if($_GET['x']=='notifikasi') echo 'active';?>">
          ...
          <li>
            <a href="contact" class="nav-link link-dark <?php if($_GET['x']=='contact') echo 'active';?>">
